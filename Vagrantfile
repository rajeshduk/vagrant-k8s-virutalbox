...
Vagrant.configure("2") do |config|
  ...
  # if you seen any issues with access plesae add and make sure this port is accssisble or login to contorle plane master and check kube-api pod is runing on kube-system namesapce
